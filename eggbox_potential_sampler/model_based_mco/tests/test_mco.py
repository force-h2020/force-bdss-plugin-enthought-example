...
class TestModelBasedMCO(unittest.TestCase):
    def setUp(self):
    ...
    def test_initialization(self):
        opt = ModelBasedOptimizationMCO(self.factory)
        self.assertEqual(opt.factory, self.factory)

    def test_subprocess_run(self):
        opt = ModelBasedOptimizationMCO(self.factory, )
        model = ModelBasedOptimizationMCOModel(self.factory)
        model.num_trials = 7
        model.num_random_trials = 11
